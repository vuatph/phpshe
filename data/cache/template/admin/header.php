...
<div class="pagetop">
	<div class="head">
		<div class="logo fl"><img src="<?php echo $pe['host_tpl'] ?>images/admin_logo.png"></div>
		<div class="head_r fr">
			<a href="admin.php" class="head_tb1"><s></s>首页</a>
			<a href="admin.php?mod=moban" class="head_tb8"><s></s>模板</a>
			<a href="admin.php?mod=db" class="head_tb5"><s></s>安全</a>
			<a href="admin.php?mod=iplog" class="head_tb3"><s></s>流量</a>
			<a href="admin.php?mod=cache" class="head_tb6"><s></s>缓存</a>
			<a href="<?php echo $pe['host_root'] ?>" target="_blank" class="head_tb7"><s></s>网店</a>
		...
		<div class="left">
			...
			<div class="fenlei">
				...
				<ul >
					...
					<li class="<?php if($vv['menumark']==$menumark):?>sel<?php endif;?>"><a href="<?php echo $vv['url'] ?>"><?php echo $vv['name'] ?></a></li>
					<?php endforeach;?>
				</ul>
				<div class="clear"></div>
			</div>
