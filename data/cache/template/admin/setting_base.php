...
<div class="right">
	...
	<div class="right_main">
		...
		<tr>
			<td class="bg_f8" align="right" width="110">网站标题：</td>
		...
		<tr>
			<td class="bg_f8" align="right">咨询 QQ：</td>
		...
		<tr>
			<td class="bg_f8" align="right">快递公司：</td>
			<td>
				<div style="width:860px">
				<?php for($i=0;$i<15;$i++):?>
				<?php $web_wlname = unserialize($info['web_wlname']['setting_value'])?>
				<input type="text" name="web_wlname[]" value="<?php echo $web_wlname[$i] ?>" class="inputall mab5 mar3" />
				<?php endfor;?>
				</div>
			</td>
		</tr>
		...
		<div class="now mat10" style="padding-right:0">
			<span class="fl">邮箱设置</span>
			<div class="clear"></div>
		</div>
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="wenzhang mat5">
		<tr>
			<td class="bg_f8" align="right" width="110">SMTP地址：</td>
			<td><input type="text" name="info[email_smtp]" value="<?php echo $info['email_smtp']['setting_value'] ?>" class="inputall input500" /> <span class="c888">（如：smtp.qq.com）</span></td>
		</tr>
		<tr>
			<td class="bg_f8" align="right">SMTP端口：</td>
			<td><input type="text" name="info[email_port]" value="<?php echo $info['email_port']['setting_value'] ?>" class="inputall input500" /></td>
		</tr>
		<tr>
			<td class="bg_f8" align="right">邮箱帐号：</td>
			<td><input type="text" name="info[email_name]" value="<?php echo $info['email_name']['setting_value'] ?>" class="inputall input500" /></td>
		</tr>
		<tr>
			<td class="bg_f8" align="right">邮箱密码：</td>
			<td><input type="password" name="info[email_pw]" value="<?php echo $info['email_pw']['setting_value'] ?>" class="inputall input500" /></td>
		</tr>
		<tr>
			<td class="bg_f8" align="right">发送者昵称：</td>
			<td><input type="text" name="info[email_nname]" value="<?php echo $info['email_nname']['setting_value'] ?>" class="inputall input500" /></td>
		</tr>
		<tr>
			<td class="bg_f8">&nbsp;</td>
			<td><input type="submit" name="pesubmit" value="提 交" class="tjbtn"></td>
