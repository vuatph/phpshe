		...
		<div class="pro_tuijian">
			...
			<div class="tuijian_list">
				...
				<div class="prolist_1" <?php if($k==4):?>style="background:none"<?php endif?>>
					<p class="prolist_img"><a href="<?php echo pe_url('product-'.$v['product_id']) ?>" title="<?php echo $v['product_name'] ?>" target="_blank"><img src="<?php echo $pe['host_root'] ?>include/image/load.gif" data-original="<?php echo pe_thumb($v['product_logo'], 150, 150) ?>" title="<?php echo $v['product_name'] ?>" /></a></p>
					...
					<p><span class="money1">¥<?php echo $v['product_money'] ?></span> <s class="num c888">¥<?php echo $v['product_smoney'] ?></s></p>
				</div>
				<?php endforeach;?>
				<div class="clear"></div>
			</div>
		...
		<div class="index_fenlei mat10">
			...
			<div class="index_prolist">
				<div class="fl prolist_left">
					...
					<div class="prolist_1">
						<p class="prolist_img"><a href="<?php echo pe_url('product-'.$vv['product_id']) ?>" title="<?php echo $vv['product_name'] ?>" target="_blank"><img src="<?php echo $pe['host_root'] ?>include/image/load.gif" data-original="<?php echo pe_thumb($vv['product_logo'], 150, 150) ?>" title="<?php echo $vv['product_name'] ?>" /></a></p>
						...
						<p><span class="money1">¥<?php echo $vv['product_money'] ?></span> <s class="num c888">¥ <?php echo $vv['product_smoney'] ?></s></p>
					</div>
					<?php endforeach;?>
				</div>
				<div class="fr prolist_right">
					...
					<li>
						<span class="fl hotimg">
							<a href="<?php echo pe_url('product-'.$vv['product_id']) ?>" title="<?php echo $vv['product_name'] ?>" target="_blank"><img src="<?php echo $pe['host_root'] ?>include/image/load.gif" data-original="<?php echo pe_thumb($vv['product_logo'], 60, 60) ?>" title="<?php echo $vv['product_name'] ?>" /></a>
						</span>
						<span class="fl hotname hotname_index">
							...
							<span class="lh20"><span class="cred num strong">¥</span><span class="num1 cred"><?php echo $vv['product_money'] ?></span></span>
						</span>
						<div class="clear"></div>
					</li>
					<?php endforeach;?>
