...
<div class="content" style="padding-top:5px">
	...
	<div class="i_tjsp_r">
		...
		<div class="i_prolist_1" <?php if(($k+1)%5==0):?>style="padding-right:0; border-right:0"<?php endif?>>
			...
			<p class="i_prolist_img"><img src="<?php echo $pe['host_tpl'] ?>images/pixel.gif" data-url="<?php echo pe_thumb($v['product_logo'], 400, 400) ?>" title="<?php echo $v['product_name'] ?>" width="195" height="195" class="js_imgload" /></p>
			...
			<div style="padding:5px 0 0">
				...
				<p class="mat8"><span class="money1 fl"><span class="num mar3">¥</span><?php echo product_money($v['product_money']) ?></span> <span class="c999 fr font12">已售<?php echo $v['product_sellnum'] ?>件</span></p>	
				<div class="clear"></div>
			</div>
			</a>
		</div>
	...
	<div class="prolist_html mat20">
		<div class="prolist_tt">
			<div class="fl"><h3><?php echo $v['category_name'] ?></h3></div>
			<a href="<?php echo pe_url('product-list-'.$v['category_id']) ?>" title="<?php echo $v['category_name'] ?>" target="_blank" class="fr mat10 c999">更多 ></a>
		...
		<div class="prolist" <?php if(($kk+1)%4==0):?>style="margin-right:0"<?php endif;?>>
			<a href="<?php echo pe_url('product-'.$vv['product_id']) ?>" title="<?php echo $vv['product_name'] ?>" target="_blank">
			<p class="prolist_img"><img src="<?php echo $pe['host_tpl'] ?>images/pixel.gif" data-url="<?php echo pe_thumb($vv['product_logo'], 400, 400) ?>" title="<?php echo $vv['product_name'] ?>" width="250" height="250" class="js_imgload" /></p>
			...
			<p class="mat20"><span class="money1 fl"><span class="num font18 mar3">¥</span><?php echo product_money($vv['product_money']) ?></span> <span class="c999 fr font12">已售<?php echo $vv['product_sellnum'] ?>件</span></p>
			<div class="clear"></div>
			</a>
		</div>
		<?php endforeach;?>
